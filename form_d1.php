...
<body style="background-color:#F6F8FF;">
    ...
    <?php
        ...
        // system 
        $noid = $_SESSION['noid'];
        $sql1 = "SELECT nn,fname,lname,no,noid,room,w,h,rob FROM data_nn WHERE noid = :noid";
    ...
    ?>
      ...
      <section id="login" class="about section-padding">
        <div class="container shadow-lg p-5 ff1 rounded-4 bg-white ">
              <h2 class="text-center"><span class="text-success"><b>บันทึกข้อมูล</b></span></h2>
              <hr>
            ...
            <div class="row " >
                ...
                <div class="col-lg-12 col-md-12 col-12 mx-auto text-center">
                  <div class="about-img text-center">
                      <img src="img/h6a.png" alt="" class="img-fluid img-save" width="20%" loading="eager">
                  </div>
                ...
                <div class="col-lg-6 col-md-12 col-12 mx-auto ">
                    <div class="about-text">
                          ...
                          <div class="col-md-12">
                              <form method="POST" action="system/save_data_to_db.php">
                                ...
                                <a href="system/logout.php" class="btn btn-secondary form-control mt-1 rounded-pill"><i class='bx bx-exit' ></i>&nbsp;ยกเลิก</a>
                              </form>
                          </div>
                    </div>
                </div>

...
<body style="background-color:#F6F8FF;">
    ...
    <?php
        ...
        // system 
        $sql = "SELECT * FROM data_nn WHERE st1 = '' ORDER BY id ASC" ; //เรียกข้อมูลจากฐานข้อมูลมาใช้งานและนับข้อมูลในฐานข้อมูล
      ...
      <section id="login" class="about section-padding">
        <div class="container shadow-lg p-5 ff1 rounded-4 bg-white">
                <div class="col-md-12 text-center ">
                    ...
                    <h2 class="text-center "><span class="text-danger"><b>นักเรียนที่ยังไม่บันทึกข้อมูล</b></span></h2>
